...
private:
  bool Rewind();
  std::size_t ReadComplexFloat32(std::vector<std::complex<float>> &output,
                                 std::size_t max_samples, std::string &error);
  std::size_t ReadComplexInt16(std::vector<std::complex<float>> &output,
                               std::size_t max_samples, std::string &error);
